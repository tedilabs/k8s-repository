...
DOWNLOAD_VERSION="v0.11.0"
DOWNLOAD_DIRECTORY="$DOWNLOAD_VERSION"

curl -Ls "$DOWNLOAD_URL/$DOWNLOAD_VERSION" -o $DOWNLOAD_VERSION.tar.gz
mkdir -p $DOWNLOAD_DIRECTORY
tar -xzf $DOWNLOAD_VERSION.tar.gz --include "**/manifests/prometheusOperator*" --include "**/manifests/setup" --directory $DOWNLOAD_DIRECTORY --strip-components 2
